...
export class GeneralSectionEditComponent implements OnInit, OnDestroy, OnChanges {
    ...
    ngOnInit() {
        ...
        if (this.generalDetails.startDate != null && this.generalDetails.endDate != null) {
    ...
    onSponsorSelect(event) {
        ...
        this._instituteService.isInstituteProposalDataChange = true;
    }
    ...
    internalDateValidation() {
        this.errorMap.delete('internalDeadline');
        ...
        if (this.generalDetails.internalDeadLineDate != null &&
            ...
            this.errorMap.set('internalDeadline',
                'Internal deadline date already passed. Please choose another sponsor deadline date.');
        }

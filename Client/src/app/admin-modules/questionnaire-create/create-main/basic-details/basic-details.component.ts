...
export class BasicDetailsComponent implements OnInit, OnDestroy {
  ...
  constructor(private _createQuestionnaireService: CreateQuestionnaireService, private _commonService: CommonService,
  ...
  */
  ...
  getRuleList() {
    this.errorMap.clear();
    this.$subscriptions.push(this._createQuestionnaireService.getRuleList(

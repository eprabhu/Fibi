...
export class DelegationComponent implements OnInit {
  ...
  resetAllDelegationData() {
    ...
    this.delegatedByPerson = this.isPersonViewMode ? this.delegatedByPerson : "";
  ...
  editDelegation() {
    ...
    this.delegationCopyData = JSON.parse(JSON.stringify(this.delegation));
  }
  ...
  cancelDelegationEdit() {
    ...
    this.delegation = JSON.parse(JSON.stringify(this.delegationCopyData));
    this.delegationCopyData = null;

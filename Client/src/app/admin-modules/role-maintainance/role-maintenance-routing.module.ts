...
import { UserRoleCreationModule } from './user-role-creation/user-role-creation.module';
...
const routes: Routes = [{
	...
	children: [
		...
		},
		{
			...
			loadChildren: () => import('./user-role-creation/user-role-creation.module').then(m => UserRoleCreationModule),
		}
	]
}];

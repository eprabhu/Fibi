...
@Component({
  ...
  template: `<app-view-questionnaire-list [configuration]="configuration" (QuestionnaireSaveEvent)="getSaveEvent($event)" (QuestionnaireEditEvent)="markQuestionnaireAsEdited($event)" [externalSaveEvent] = '_autoSaveService.autoSaveTrigger$'
  [isShowSave] = false [isShowCollapse]=true> </app-view-questionnaire-list>`
})

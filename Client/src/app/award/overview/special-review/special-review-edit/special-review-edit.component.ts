    ...
    addSpecialReview() {
        ...
        if (this.map.size < 1 && this.validateSpecialReviewDates() && !this.isSaving) {
            ...
            const REQ_OBJ = {
                ...
                'updateType': this.getType(this.specialReviews.awardSpecailReviewId),
            ...
            this.$subscriptions.push(this._overviewService.saveSpecialReview(REQ_OBJ).subscribe((data: any) => {
                ...
                (this.type === 'SAVE') ? this.specialReviewData.push(this.specialReviews) :
        ...
        if (this.removeSpecialReviewId != null) {
            this.$subscriptions.push(this._overviewService.deleteSpecialReview(
              { 'personId': this._commonService.getCurrentUserDetail('personID'),
                ...
                err => {  this._commonService.showToast(HTTP_ERROR_STATUS, 'Removing Special review failed. Please try again.');
            }));
        }
    }

...
export class TaskSideNavBarComponent implements OnInit, OnDestroy {
      ...
      if (!this.isSaving) {
        ...
        this.$subscriptions.push(this._taskNavService.startTask({
          ...
          'moduleItemId': this.awardData.award.awardId
            ...
            this.showToast(HTTP_SUCCESS_STATUS, 'Task started succesfully.', this.operatinOnTask);
          }));
      }
  }
  ...
  completeTask() {
    this.$subscriptions.push(this._taskNavService.completeTask({
      ...
      this.showToast(HTTP_SUCCESS_STATUS, 'Task completed succesfully', this.operatinOnTask);
    }));
  }
    ...
    cancelTask() {
        if (!this.isSaving) {
            ...
            this.$subscriptions.push(this._taskNavService.cancelTask({
                ...
                this.showToast(HTTP_SUCCESS_STATUS, 'Task cancelled succesfully.', this.operatinOnTask);
            }));
        }
    }

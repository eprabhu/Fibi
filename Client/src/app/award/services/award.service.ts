...
export class AwardService {
    ...
    generateNotifyAwardReports(awardId, awardNumber, sequenceNumber) {
        return this._http.get(this._commonService.baseUrl + '/generateNotifyAwardReports', {
            headers: new HttpHeaders().set('awardId', awardId.toString()).set('updateUser', this._commonService.getCurrentUserDetail('userName')).
                set('personId', this._commonService.getCurrentUserDetail('personID')).set('awardNumber', awardNumber.toString()).

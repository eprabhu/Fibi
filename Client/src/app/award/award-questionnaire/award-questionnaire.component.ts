...
@Component({
  ...
  template: `<div *ngIf="_commonDataService.awardSectionConfig['124'].isActive"><app-view-questionnaire-list [configuration] = "configuration"
  (QuestionnaireSaveEvent)= "getSaveEvent($event)" (QuestionnaireEditEvent)="markQuestionnaireAsEdited($event)"></app-view-questionnaire-list></div>`,

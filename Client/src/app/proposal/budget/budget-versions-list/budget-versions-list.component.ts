...
export class BudgetVersionsListComponent implements OnDestroy, OnChanges {
    ...
    setApprovedBudgetFlag() {
        ...
        if (this.isCreateApprovedBudget) {
            this.isCreateApprovedBudget = this._websocket.isModuleLockAvailable === 'NotAvailAble' ? false : true;
        }
    }
    ...
    */
    setCreateBudgetVersionFlag() {
        ...
        if (this.isCreateBudgetVersion) {
            this.isCreateBudgetVersion = this._websocket.isModuleLockAvailable === 'NotAvailAble' ? false : true;
        }
    }
    ...
    setCopyDeleteFlag() {
        ...
        if (this.isCopyDeleteAllowed) {
            this.isCopyDeleteAllowed = this._websocket.isModuleLockAvailable === 'NotAvailAble' ? false : true;
        }
    }

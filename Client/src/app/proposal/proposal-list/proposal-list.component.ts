...
export class ProposalListComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.grantHttpOptions = this._proposalService.setHttpOptions('grantCallName', 'grantCallName', 'findGrantCall',
            '', { 'moduleCode': '3', 'includeClosedGrantCall': 'true' });
    ...
    checkForAdvanceSearch() {
        if (this.isAdvancedSearchMade() && this._navigationService.previousURL.includes('fibi/proposal')) {
            ...
            this.switchAdvanceSearchProperties(this.tempProposalRequestObject, this._proposalService.proposalRequestServiceObject);
            ...
            this.clearAdvanceSearchField(true);
            this.$proposalList.next();
        }
    }
    ...
    setDefaultValueForCustomLibrarySearch() {
        ...
        this.grantHttpOptions.defaultValue = this._proposalService.proposalRequestExtraData.grantCallName;
    }
    ...
    generateLookupArrayForDropdown() {
        ...
        if (this._proposalService.proposalRequestServiceObject.property13.length) {
            ...
            this.lookupValues['property13'] = [{ code: '3' }];        // Setting PI(code:3) as default role value
        }
    }
    ...
    */
    ...
    clearAdvanceSearchField(researchRoleValue) {
        this.clearAdvanceSearchList(researchRoleValue);
    ...
    setGrantCallForAdvancedSearch(event) {
        (event) ? this.tempProposalRequestObject.property9 = event.grantCallId : this.tempProposalRequestObject.property9 = null;
        this.tempProposalRequestObject.grantCallName = event ? event.grantCallName : '';
    }
   ...
   */
    ...
    */
    ...
    printProposal(event, proposalId, piName) {
        event.preventDefault();
        this.$subscriptions.push(this._proposalService.printEntireProposal({ proposalId }).subscribe(
            data => {
                fileDownloader(data, 'Proposal_' + proposalId + '_' + piName, 'zip');
            }));
    }
    ...
    exportProposalsAsZip() {
        ...
        if (isAssignedProposalArrays.length === 0) {
            ...
            isAssignedProposalArrays.forEach(element => {
                this.$subscriptions.push(this._proposalService.printEntireProposal({'proposalId' : element.proposalId})
                    .subscribe(data => {
  ...
  */
    ...
    */
    ...
    setCurrentDashboardTab(currentTab: string) {
        ...
        this.resetSearchOptions();
        this.setAdvanceSearch();
        this.clearAdvanceSearchList(true);
        this.$proposalList.next();
    }
    ...
    clearAdvanceSearchList(researchRoleValue) {
        ...
        if (researchRoleValue) {
            this.lookupValues['property13'] = [{ code: '3' }];
            this._proposalService.proposalRequestServiceObject.property13 = ['3'];
            this.tempProposalRequestObject.property13 = ['3'];  // Setting PI(code:3) as default role value
            this._proposalService.proposalRequestServiceObject.advancedSearch = 'A';
        } else {
            this._proposalService.proposalRequestServiceObject.advancedSearch = 'L';
        }
    ...
    searchProposal() {
        this.switchAdvanceSearchProperties(this._proposalService.proposalRequestServiceObject, this.tempProposalRequestObject);

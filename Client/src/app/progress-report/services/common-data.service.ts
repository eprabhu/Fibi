...
export class CommonDataService {
     ...
     * Why writtern is service? -  validation check has to happen when Save button clicked (in progress-report-overview component) and When clicked on Submit Report (in progress-report component)
     * Logic: Summary fields(sectionType = S) should be mandatory for reportClassCode 1( not final report) and reportClassCode 2 (final report).

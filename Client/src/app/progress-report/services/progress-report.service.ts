...
export class ProgressReportService {
    ...
    downloadProgressReportAsExcel(progressReportId) {
        return this._http.get(`${this._commonService.baseUrl}/generateProgressReport/${progressReportId}`, {
            responseType: 'blob'
        });
    }
    ...
    downloadProgressReportAsZip(params) {
        return this._http.get(this._commonService.baseUrl + '/printEntireProgressReport', {
            headers: new HttpHeaders().set( 'progressReportId', params.progressReportId.toString()).set('awardId', params.awardId.toString()).

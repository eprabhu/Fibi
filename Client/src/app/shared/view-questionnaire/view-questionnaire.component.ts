 ...
 **/
 ...
 import { easeIn } from '../../admin-modules/questionnaire-create/services/animations';
 import { compareDatesWithoutTimeZone } from '../../common/utilities/date-utilities';
 import { Question, TableAnswer } from '../../admin-modules/questionnaire-create/questionnaire.interface';
 @Component({
 ...
 export class ViewQuestionnaireComponent implements OnInit, OnChanges, OnDestroy {
     ...
     */
     autoSaveEvent() {
         if (!this.isViewMode && this.externalSaveEvent) {
           this.$subscriptions.push(this.externalSaveEvent.subscribe(_event =>
            this.questionnaireDetails.isChanged && this.saveQuestionnaire()
            ));
         }
     }

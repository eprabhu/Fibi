...
import { DATE_PICKER_FORMAT, DATE_PICKER_FORMAT_MATERIAL } from '../app-constants';
...
import { ReportFilterPipe } from '../report/report-filter.pipe';
...
@ NgModule({
  ...
  declarations: [AppElasticComponent, FileDropComponent, DragNdropDirective, AppAutocompleterComponent,
    ...
    DateFormatPipeWithTimeZone, SafeHtmlPipe, CustomNumberPipe, CustomPreloaderDirective, ReportFilterPipe, OrderByPipe, OrderByIndexPipe,
    DragNDragDirective],
  exports: [
    AppElasticComponent,
    FileDropComponent,

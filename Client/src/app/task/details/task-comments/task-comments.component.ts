...
/** to validate the comment box  */
  ...
  toastForUpdatingComment() {
    this._commonService.showToast(HTTP_SUCCESS_STATUS, 'Task Comment updated Succesfully');
    this.isEditComment = false;
  }

  toastForAddingComment() {
    this._commonService.showToast(HTTP_SUCCESS_STATUS, 'Task Comment added Succesfully');
  }

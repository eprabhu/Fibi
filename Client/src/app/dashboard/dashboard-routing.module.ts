...
const routes: Routes = [{
    ...
    children: [
        ...
        {
            path: 'disclosure', loadChildren: () => import('../disclosure/disclosure-list/disclosure-list.module')
                .then(m => m.DisclosureListModule), canActivate: [AuthGuard]
        },
        {
            path: 'committee', loadChildren: () => import('../commitee/commitee-list/commitee-list.module')
                .then(m => m.CommiteeListModule), canActivate: [AuthGuard]
        },
        {
            path: 'schedule', loadChildren: () => import('../schedule/Schedule-list/Schedule-list.module')
                .then(m => m.ScheduleListModule), canActivate: [AuthGuard]
        },
        {

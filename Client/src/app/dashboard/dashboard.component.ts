...
// The function is used for closing nav dropdown at mobile screen
    ...
    async getPermissions() {
        ...
        this.isReportViewer = await this._commonService.checkPermissionAllowed('REPORT_VIEWER');
        this.isReportAdministrator = await this._commonService.checkPermissionAllowed('REPORT_ADMINISTATOR');

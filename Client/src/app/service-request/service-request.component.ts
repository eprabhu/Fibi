...
import { COMMON_APPROVE_LABEL, COMMON_RETURN_LABEL, HTTP_ERROR_STATUS, HTTP_SUCCESS_STATUS } from '../app-constants';
import { AutoSaveService } from '../common/services/auto-save.service';
import { CommonService } from '../common/services/common.service';
import { ElasticConfigService } from '../common/services/elastic-config.service';
import { subscriptionHandler } from '../common/utilities/subscription-handler';
import {
    AdminGroup, AssignRequest, CompleterOptions, ServiceRequest, ServiceRequestRoot,
   ...
   */
    ...
    private showSuccessToast(): void {
        if (this.requestObject.actionType === 'A') {
            ...
            this.showSuccessMessage(`Service request ${COMMON_RETURN_LABEL.toLowerCase()}d successfully.`);
        }
    }

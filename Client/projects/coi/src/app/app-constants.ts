...
export const AWARD_EXTERNAL_RESOURCE_URL = 'http://10.199.100.15:2500/#/fibi/award/overview?awardId={awardId}';
export const PROPOSAL_EXTERNAL_RESOURCE_URL = 'http://10.199.100.15:2500/#/fibi/proposal/overview?proposalId={developmentProposalId}';
export const IP_EXTERNAL_RESOURCE_URL = 'http://10.199.100.15:2500/#/fibi/instituteproposal/overview?instituteProposalId={instituteProposalId}';

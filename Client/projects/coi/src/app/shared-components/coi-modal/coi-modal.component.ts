 ...
 *
 * Usage:
 * 1. Import the CoiModalComponent in the parent component's module.
 * 2. Add the CoiModalComponent selector '<app-common-modal></app-common-modal>' in the parent component's template.
...
import { COIModalConfig, ModalActionEvent } from './coi-modal.interface';

@Component({
    selector: 'app-coi-modal',
    templateUrl: './coi-modal.component.html',
    styleUrls: ['./coi-modal.component.scss']
})
export class CoiModalComponent {

    @Input() modalConfig = new COIModalConfig('coi-common-modal', 'Ok', 'Cancel', '');

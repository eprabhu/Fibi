...
INSERT INTO `OPA_REVIEW_REVIEWER_STATUS_TYPE` (`REVIEW_STATUS_CODE`, `DESCRIPTION`, `IS_ACTIVE`, `UPDATE_TIMESTAMP`, `UPDATE_USER`) VALUES ('1', 'Assigned', 'Y', now(), 'quickstart');
INSERT INTO `OPA_REVIEW_REVIEWER_STATUS_TYPE` (`REVIEW_STATUS_CODE`, `DESCRIPTION`, `IS_ACTIVE`, `UPDATE_TIMESTAMP`, `UPDATE_USER`) VALUES ('2', 'In Progress', 'Y', now(), 'quickstart');
INSERT INTO `OPA_REVIEW_REVIEWER_STATUS_TYPE` (`REVIEW_STATUS_CODE`, `DESCRIPTION`, `IS_ACTIVE`, `UPDATE_TIMESTAMP`, `UPDATE_USER`) VALUES ('3', 'Completed', 'Y', now(), 'quickstart');
...
ALTER TABLE opa_discl_person_entity ADD COLUMN PERSON_ENTITY_NUMBER INT;


/**
  Review comments table changes on revamp
...
CREATE TABLE `discl_comment` (
  ...
  `SUB_MODULE_ITEM_KEY` INT(11) DEFAULT NULL,
  `SUB_MODULE_ITEM_NUMBER` VARCHAR(11) DEFAULT NULL,
  `MODULE_CODE` INT(4) NOT NULL,
  `SUB_MODULE_CODE` INT(4) DEFAULT NULL,
...
INSERT INTO `DISCL_COMPONENT_TYPE` (`COMPONENT_TYPE_CODE`, `DESCRIPTION`, `IS_ACTIVE`, `UPDATE_TIMESTAMP`, `UPDATE_USER`) VALUES ('1', 'Disclosure detail comment', 'Y', now(),'quickstart');
INSERT INTO `DISCL_COMPONENT_TYPE` (`COMPONENT_TYPE_CODE`, `DESCRIPTION`, `IS_ACTIVE`, `UPDATE_TIMESTAMP`, `UPDATE_USER`) VALUES ('2', 'Travel disclosure conflict comment', 'Y', now(), 'quickstart');
INSERT INTO `DISCL_COMPONENT_TYPE` (`COMPONENT_TYPE_CODE`, `DESCRIPTION`, `IS_ACTIVE`, `UPDATE_TIMESTAMP`, `UPDATE_USER`) VALUES ('3', 'General', 'Y', now(), 'quickstart');
INSERT INTO `DISCL_COMPONENT_TYPE` (`COMPONENT_TYPE_CODE`, `DESCRIPTION`, `IS_ACTIVE`, `UPDATE_TIMESTAMP`, `UPDATE_USER`) VALUES ('4', 'Questionnaire', 'Y', now(), 'quickstart');
INSERT INTO `DISCL_COMPONENT_TYPE` (`COMPONENT_TYPE_CODE`, `DESCRIPTION`, `IS_ACTIVE`, `UPDATE_TIMESTAMP`, `UPDATE_USER`) VALUES ('5', 'SFIs', 'Y', now(), 'quickstart');
INSERT INTO `DISCL_COMPONENT_TYPE` (`COMPONENT_TYPE_CODE`, `DESCRIPTION`, `IS_ACTIVE`, `UPDATE_TIMESTAMP`, `UPDATE_USER`) VALUES ('6', 'Project relationships', 'Y', now(), 'quickstart');
INSERT INTO `DISCL_COMPONENT_TYPE` (`COMPONENT_TYPE_CODE`, `DESCRIPTION`, `IS_ACTIVE`, `UPDATE_TIMESTAMP`, `UPDATE_USER`) VALUES ('7', 'Certification', 'Y', now(), 'quickstart');
INSERT INTO `DISCL_COMPONENT_TYPE` (`COMPONENT_TYPE_CODE`, `DESCRIPTION`, `IS_ACTIVE`, `UPDATE_TIMESTAMP`, `UPDATE_USER`) VALUES ('8', 'Review Comment', 'Y', now(), 'quickstart');
INSERT INTO `DISCL_COMPONENT_TYPE` (`COMPONENT_TYPE_CODE`, `DESCRIPTION`, `IS_ACTIVE`, `UPDATE_TIMESTAMP`, `UPDATE_USER`) VALUES ('9', 'OPA General Comment', 'Y', now(), 'quickstart');
INSERT INTO `DISCL_COMPONENT_TYPE` (`COMPONENT_TYPE_CODE`, `DESCRIPTION`, `IS_ACTIVE`, `UPDATE_TIMESTAMP`, `UPDATE_USER`) VALUES ('10','OPA Form Comment', 'Y', now(), 'quickstart');
INSERT INTO `DISCL_COMPONENT_TYPE` (`COMPONENT_TYPE_CODE`, `DESCRIPTION`, `IS_ACTIVE`, `UPDATE_TIMESTAMP`, `UPDATE_USER`) VALUES ('11','OPA Review Comment', 'Y', now(), 'quickstart');
...
ALTER TABLE `person_entity`
CHANGE COLUMN `IS_RELATIONSHIP_ACTIVE` `IS_FORM_COMPLETED` VARCHAR(1) NULL DEFAULT NULL ;
...
ALTER TABLE `opa_review`
DROP FOREIGN KEY `OPA_REVIEW_FK3`;
ALTER TABLE `opa_review`
ADD INDEX `OPA_REVIEW_FK3_idx` (`REVIEW_STATUS_TYPE_CODE` ASC) VISIBLE,
DROP INDEX `OPA_REVIEW_FK3_idx` ;
;
ALTER TABLE `opa_review`
ADD CONSTRAINT `OPA_REVIEW_FK3`
  FOREIGN KEY (`REVIEW_STATUS_TYPE_CODE`)
  REFERENCES `OPA_REVIEW_REVIEWER_STATUS_TYPE` (`REVIEW_STATUS_CODE`);
...
ALTER TABLE `opa_disclosure`
DROP FOREIGN KEY `OPA_DISCLOSURE_FK2`;

ALTER TABLE `opa_disclosure`
CHANGE COLUMN `OPA_DISCLOSURE_STATUS_CODE` `REVIEW_STATUS_CODE` VARCHAR(3) NULL DEFAULT NULL;

ALTER TABLE `opa_disclosure`
ADD CONSTRAINT `OPA_DISCLOSURE_FK2`
  FOREIGN KEY (`REVIEW_STATUS_CODE`)
  REFERENCES `opa_review_status_type` (`REVIEW_STATUS_CODE`);

DROP TABLE IF EXISTS `OPA_DISCLOSURE_STATUS_TYPE`;

INSERT INTO `OPA_REVIEW_STATUS_TYPE` (`REVIEW_STATUS_CODE`,`DESCRIPTION`,`IS_ACTIVE`,`UPDATE_TIMESTAMP`,`UPDATE_USER`,`SORT_ORDER`)
VALUES ('1','Pending','Y',now(),'quickstart',1);
INSERT INTO `OPA_REVIEW_STATUS_TYPE` (`REVIEW_STATUS_CODE`,`DESCRIPTION`,`IS_ACTIVE`,`UPDATE_TIMESTAMP`,`UPDATE_USER`,`SORT_ORDER`)
VALUES ('2','Submitted','Y',now(),'quickstart',2);
INSERT INTO `OPA_REVIEW_STATUS_TYPE` (`REVIEW_STATUS_CODE`,`DESCRIPTION`,`IS_ACTIVE`,`UPDATE_TIMESTAMP`,`UPDATE_USER`,`SORT_ORDER`)
VALUES ('3','Review in progress','Y',now(),'quickstart',3);
INSERT INTO `OPA_REVIEW_STATUS_TYPE` (`REVIEW_STATUS_CODE`,`DESCRIPTION`,`IS_ACTIVE`,`UPDATE_TIMESTAMP`,`UPDATE_USER`,`SORT_ORDER`)
VALUES ('7','Review Assigned','Y',now(),'quickstart',4);
INSERT INTO `OPA_REVIEW_STATUS_TYPE` (`REVIEW_STATUS_CODE`,`DESCRIPTION`,`IS_ACTIVE`,`UPDATE_TIMESTAMP`,`UPDATE_USER`,`SORT_ORDER`)
VALUES ('8','Assigned Review Completed','Y',now(),'quickstart',5);
INSERT INTO `OPA_REVIEW_STATUS_TYPE` (`REVIEW_STATUS_CODE`,`DESCRIPTION`,`IS_ACTIVE`,`UPDATE_TIMESTAMP`,`UPDATE_USER`,`SORT_ORDER`)
VALUES ('4','Completed','Y',now(),'quickstart',6);
INSERT INTO `OPA_REVIEW_STATUS_TYPE` (`REVIEW_STATUS_CODE`,`DESCRIPTION`,`IS_ACTIVE`,`UPDATE_TIMESTAMP`,`UPDATE_USER`,`SORT_ORDER`)
VALUES ('6','Withdrawn','Y',now(),'quickstart',7);
INSERT INTO `OPA_REVIEW_STATUS_TYPE` (`REVIEW_STATUS_CODE`,`DESCRIPTION`,`IS_ACTIVE`,`UPDATE_TIMESTAMP`,`UPDATE_USER`,`SORT_ORDER`)
VALUES ('5','Returned','Y',now(),'quickstart',8);

ALTER TABLE `coi_risk_category`
ADD COLUMN `SORT_ORDER` INT;

UPDATE `COI_RISK_CATEGORY` SET `SORT_ORDER` = '1' WHERE (`RISK_CATEGORY_CODE` = '3');
UPDATE `COI_RISK_CATEGORY` SET `SORT_ORDER` = '2' WHERE (`RISK_CATEGORY_CODE` = '2');
UPDATE `COI_RISK_CATEGORY` SET `SORT_ORDER` = '3' WHERE (`RISK_CATEGORY_CODE` = '1');

ALTER TABLE `ENTITY_RISK_CATEGORY`
ADD COLUMN `SORT_ORDER` INT;

UPDATE `ENTITY_RISK_CATEGORY` SET `SORT_ORDER` = '1' WHERE (`RISK_CATEGORY_CODE` = '3');
UPDATE `ENTITY_RISK_CATEGORY` SET `SORT_ORDER` = '2' WHERE (`RISK_CATEGORY_CODE` = '2');
UPDATE `ENTITY_RISK_CATEGORY` SET `SORT_ORDER` = '3' WHERE (`RISK_CATEGORY_CODE` = '1');

ALTER TABLE `COI_REVIEWER_STATUS_TYPE`
ADD COLUMN `SORT_ORDER` INT;

UPDATE `COI_REVIEWER_STATUS_TYPE` SET `SORT_ORDER` = '1' WHERE (`REVIEW_STATUS_CODE` = '1');
UPDATE `COI_REVIEWER_STATUS_TYPE` SET `SORT_ORDER` = '2' WHERE (`REVIEW_STATUS_CODE` = '3');
UPDATE `COI_REVIEWER_STATUS_TYPE` SET `SORT_ORDER` = '3' WHERE (`REVIEW_STATUS_CODE` = '2');

ALTER TABLE `COI_REVIEW_STATUS_TYPE`
ADD COLUMN `SORT_ORDER` INT;

UPDATE `COI_REVIEW_STATUS_TYPE` SET `SORT_ORDER` = '1' WHERE (`REVIEW_STATUS_CODE` = '1');
UPDATE `COI_REVIEW_STATUS_TYPE` SET `SORT_ORDER` = '2' WHERE (`REVIEW_STATUS_CODE` = '2');
UPDATE `COI_REVIEW_STATUS_TYPE` SET `SORT_ORDER` = '3' WHERE (`REVIEW_STATUS_CODE` = '3');
UPDATE `COI_REVIEW_STATUS_TYPE` SET `SORT_ORDER` = '4' WHERE (`REVIEW_STATUS_CODE` = '7');
UPDATE `COI_REVIEW_STATUS_TYPE` SET `SORT_ORDER` = '5' WHERE (`REVIEW_STATUS_CODE` = '8');
UPDATE `COI_REVIEW_STATUS_TYPE` SET `SORT_ORDER` = '6' WHERE (`REVIEW_STATUS_CODE` = '4');
UPDATE `COI_REVIEW_STATUS_TYPE` SET `SORT_ORDER` = '8' WHERE (`REVIEW_STATUS_CODE` = '5');
UPDATE `COI_REVIEW_STATUS_TYPE` SET `SORT_ORDER` = '7' WHERE (`REVIEW_STATUS_CODE` = '6');

ALTER TABLE `COI_DISPOSITION_STATUS_TYPE`
ADD COLUMN `SORT_ORDER` INT;

UPDATE `COI_DISPOSITION_STATUS_TYPE` SET `SORT_ORDER` = '1' WHERE (`DISPOSITION_STATUS_CODE` = '1');
UPDATE `COI_DISPOSITION_STATUS_TYPE` SET `SORT_ORDER` = '2' WHERE (`DISPOSITION_STATUS_CODE` = '3');
UPDATE `COI_DISPOSITION_STATUS_TYPE` SET `SORT_ORDER` = '3' WHERE (`DISPOSITION_STATUS_CODE` = '2');

ALTER TABLE `COI_CONFLICT_STATUS_TYPE`
ADD COLUMN `SORT_ORDER` INT;

UPDATE `COI_CONFLICT_STATUS_TYPE` SET `SORT_ORDER` = '1' WHERE (`CONFLICT_STATUS_CODE` = '1');
UPDATE `COI_CONFLICT_STATUS_TYPE` SET `SORT_ORDER` = '2' WHERE (`CONFLICT_STATUS_CODE` = '2');
UPDATE `COI_CONFLICT_STATUS_TYPE` SET `SORT_ORDER` = '3' WHERE (`CONFLICT_STATUS_CODE` = '3');
UPDATE `COI_CONFLICT_STATUS_TYPE` SET `SORT_ORDER` = '4' WHERE (`CONFLICT_STATUS_CODE` = '4');

ALTER TABLE `COI_TRAVEL_DISCLOSURE_STATUS`
ADD COLUMN `SORT_ORDER` INT;

UPDATE `COI_TRAVEL_DISCLOSURE_STATUS` SET `SORT_ORDER` = '1' WHERE (`TRAVEL_DISCLOSURE_STATUS_CODE` = '1');
UPDATE `COI_TRAVEL_DISCLOSURE_STATUS` SET `SORT_ORDER` = '2' WHERE (`TRAVEL_DISCLOSURE_STATUS_CODE` = '2');
UPDATE `COI_TRAVEL_DISCLOSURE_STATUS` SET `SORT_ORDER` = '3' WHERE (`TRAVEL_DISCLOSURE_STATUS_CODE` = '3');
UPDATE `COI_TRAVEL_DISCLOSURE_STATUS` SET `SORT_ORDER` = '4' WHERE (`TRAVEL_DISCLOSURE_STATUS_CODE` = '4');

ALTER TABLE `OPA_DISPOSITION_STATUS_TYPE`
ADD COLUMN `SORT_ORDER` INT;


UPDATE `OPA_DISPOSITION_STATUS_TYPE` SET `SORT_ORDER` = '1' WHERE (`DISPOSITION_STATUS_CODE` = '1');
UPDATE `OPA_DISPOSITION_STATUS_TYPE` SET `SORT_ORDER` = '3' WHERE (`DISPOSITION_STATUS_CODE` = '2');
UPDATE `OPA_DISPOSITION_STATUS_TYPE` SET `SORT_ORDER` = '2' WHERE (`DISPOSITION_STATUS_CODE` = '3');

ALTER TABLE `OPA_REVIEW_REVIEWER_STATUS_TYPE`
ADD COLUMN `SORT_ORDER` INT;

UPDATE `OPA_REVIEW_REVIEWER_STATUS_TYPE` SET `SORT_ORDER` = '1' WHERE (`REVIEW_STATUS_CODE` = '1');
UPDATE `OPA_REVIEW_REVIEWER_STATUS_TYPE` SET `SORT_ORDER` = '2' WHERE (`REVIEW_STATUS_CODE` = '2');
UPDATE `OPA_REVIEW_REVIEWER_STATUS_TYPE` SET `SORT_ORDER` = '3' WHERE (`REVIEW_STATUS_CODE` = '3');

ALTER TABLE `OPA_REVIEW_STATUS_TYPE`
ADD COLUMN `SORT_ORDER` INT;

UPDATE `OPA_REVIEW_STATUS_TYPE` SET `SORT_ORDER` = '1' WHERE (`REVIEW_STATUS_CODE` = '1');
UPDATE `OPA_REVIEW_STATUS_TYPE` SET `SORT_ORDER` = '2' WHERE (`REVIEW_STATUS_CODE` = '2');
UPDATE `OPA_REVIEW_STATUS_TYPE` SET `SORT_ORDER` = '3' WHERE (`REVIEW_STATUS_CODE` = '3');
UPDATE `OPA_REVIEW_STATUS_TYPE` SET `SORT_ORDER` = '4' WHERE (`REVIEW_STATUS_CODE` = '7');
UPDATE `OPA_REVIEW_STATUS_TYPE` SET `SORT_ORDER` = '5' WHERE (`REVIEW_STATUS_CODE` = '8');
UPDATE `OPA_REVIEW_STATUS_TYPE` SET `SORT_ORDER` = '6' WHERE (`REVIEW_STATUS_CODE` = '4');
UPDATE `OPA_REVIEW_STATUS_TYPE` SET `SORT_ORDER` = '7' WHERE (`REVIEW_STATUS_CODE` = '6');
UPDATE `OPA_REVIEW_STATUS_TYPE` SET `SORT_ORDER` = '8' WHERE (`REVIEW_STATUS_CODE` = '5');

INSERT INTO `form_builder_usage` (`FORM_BUILDER_ID`, `FORM_BUILDER_NUMBER`, `FORM_ORDER_NUMBER`, `MODULE_CODE`, `SUB_MODULE_CODE`, `DESCRIPTION`, `IS_ACTIVE`, `CREATE_TIMESTAMP`, `CREATE_USER`, `UPDATE_TIMESTAMP`, `UPDATE_USER`) 
VALUES 
('3', '1003', '1', '23', '0', 'Faculty OPA Form', 'Y', now(), 'admin', now(), 'admin');

INSERT INTO `business_rule_function` (`FUNCTION_NAME`, `MODULE_CODE`, `SUB_MODULE_CODE`, `DESCRIPTION`, `DB_FUNCTION_NAME`, `UPDATE_TIMESTAMP`, `UPDATE_USER`) VALUES ('For checking if document owner is faculty or not', '23', '0', 'For checking if document owner is faculty or not', 'FN_CHK_OPA_PERSON_IS_FACULTY', now(), 'quickstart');

INSERT INTO `business_rule_function_arg` (`FUNCTION_NAME`, `ARGUMENT_SEQUENCE_NUMBER`, `ARGUMENT_NAME`, `UPDATE_TIMESTAMP`, `UPDATE_USER`) 
VALUES ('For checking if document owner is faculty or not', '1', 'AV_PERSON_ID', now(), 'quickstart');


INSERT INTO `business_rules` (`RULE_ID`, `DESCRIPTION`, `RULE_TYPE`, `UNIT_NUMBER`, `MODULE_CODE`, `SUB_MODULE_CODE`, `IS_ACTIVE`, `RULE_EXPRESSION`, `UPDATE_TIMESTAMP`, `UPDATE_USER`, `NOTIFICATION_ID`, `USER_MESSAGE`, `RULE_EVALUATION_ORDER`, `RULE_CATEGORY`) 
VALUES ((SELECT T.ID FROM (SELECT MAX(RULE_ID) + 1 AS ID FROM business_rules) AS T), 'OPA Faculty Form selection rule', 'Q', '000001', '23', '0', 'Y', ' ( E1 )', now(), 'quickstart', '0', '', '1', 'R');

INSERT INTO business_rules_experssion(RULES_EXPERSSION_ID, RULE_ID, EXPRESSION_NUMBER, EXPRESSION_TYPE_CODE, LVALUE, CONDITION_OPERATOR, RVALUE, UPDATE_TIMESTAMP, UPDATE_USER, PARENT_EXPRESSION_NUMBER) 
VALUES
((SELECT T.ID FROM (SELECT MAX(RULES_EXPERSSION_ID) + 1 AS ID FROM business_rules_experssion) AS T), (SELECT MAX(RULE_ID)  AS ID FROM business_rules), '1', 'F', 'For checking if document owner is faculty or not', 'Equal to', 'True', now(), 'quickstart', '0');

UPDATE `form_builder_usage` SET `BUSINESS_RULE_ID` = (SELECT MAX(RULE_ID)  AS ID FROM business_rules) WHERE (`FORM_USAGE_ID` = '3');

INSERT INTO `business_rules` (`RULE_ID`, `DESCRIPTION`, `RULE_TYPE`, `UNIT_NUMBER`, `MODULE_CODE`, `SUB_MODULE_CODE`, `IS_ACTIVE`, `RULE_EXPRESSION`, `UPDATE_TIMESTAMP`, `UPDATE_USER`, `NOTIFICATION_ID`, `USER_MESSAGE`, `RULE_EVALUATION_ORDER`, `RULE_CATEGORY`) 
VALUES ((SELECT T.ID FROM (SELECT MAX(RULE_ID) + 1 AS ID FROM business_rules) AS T), 'OPA Staff Form selection rule', 'Q', '000001', '23', '0', 'Y', ' ( E1 )', now(), 'quickstart', '0', '', '2', 'R');

INSERT INTO business_rules_experssion(RULES_EXPERSSION_ID, RULE_ID, EXPRESSION_NUMBER, EXPRESSION_TYPE_CODE, LVALUE, CONDITION_OPERATOR, RVALUE, UPDATE_TIMESTAMP, UPDATE_USER, PARENT_EXPRESSION_NUMBER) 
VALUES
((SELECT T.ID FROM (SELECT MAX(RULES_EXPERSSION_ID) + 1 AS ID FROM business_rules_experssion) AS T), (SELECT MAX(RULE_ID)  AS ID FROM business_rules), '1', 'F', 'For checking if document owner is faculty or not', 'Equal to', 'False', now(), 'quickstart', '0');

UPDATE `form_builder_usage` SET `BUSINESS_RULE_ID` = (SELECT MAX(RULE_ID)  AS ID FROM business_rules) WHERE (`FORM_USAGE_ID` = '2');
...
INSERT INTO `PERSON_ENTITY_ACTION_TYPE` (`ACTION_TYPE_CODE`,`MESSAGE`, `DESCRIPTION`, `UPDATE_TIMESTAMP`, `UPDATE_USER`)
VALUES ('7', 'SFI <b>completed</b>', 'Completed', now(), 'quickstart');

UPDATE `VALID_PERSON_ENTITY_REL_TYPE` SET `DESCRIPTION` = 'Traveller' WHERE (`VALID_PERS_ENTITY_REL_TYP_CODE` = '4');

INSERT INTO `rights` (`RIGHT_ID`, `RIGHT_NAME`, `DESCRIPTION`, `UPDATE_USER`, `UPDATE_TIMESTAMP`, `RIGHTS_TYPE_CODE`) 
VALUES ((SELECT A.ID FROM (SELECT MAX(RIGHT_ID) + 1 AS ID FROM RIGHTS ) AS A),'MAINTAIN_FCOI_PRIVATE_COMMENTS', 'To add and view private comments in COI disclosure', 'quickstart', now(), '2');

INSERT INTO`rights` (`RIGHT_ID`, `RIGHT_NAME`, `DESCRIPTION`, `UPDATE_USER`, `UPDATE_TIMESTAMP`, `RIGHTS_TYPE_CODE`) 
VALUES ((SELECT A.ID FROM (SELECT MAX(RIGHT_ID) + 1 AS ID FROM RIGHTS ) AS A),'VIEW_FCOI_PRIVATE_COMMENTS', 'To view private comments tagged in COI disclosure', 'quickstart', now(), '2');

INSERT INTO `rights` (`RIGHT_ID`, `RIGHT_NAME`, `DESCRIPTION`, `UPDATE_USER`, `UPDATE_TIMESTAMP`, `RIGHTS_TYPE_CODE`) 
VALUES ((SELECT A.ID FROM (SELECT MAX(RIGHT_ID) + 1 AS ID FROM RIGHTS ) AS A),'MAINTAIN_OPA_PRIVATE_COMMENTS', 'To add and view private comments in OPA disclosure', 'quickstart', now(), '2');

INSERT INTO `rights` (`RIGHT_ID`, `RIGHT_NAME`, `DESCRIPTION`, `UPDATE_USER`, `UPDATE_TIMESTAMP`, `RIGHTS_TYPE_CODE`) 
VALUES ((SELECT A.ID FROM (SELECT MAX(RIGHT_ID) + 1 AS ID FROM RIGHTS ) AS A),'VIEW_OPA_PRIVATE_COMMENTS', 'To view private comments tagged in OPA disclosure', 'quickstart', now(), '2');

INSERT INTO `rights` (`RIGHT_ID`, `RIGHT_NAME`, `DESCRIPTION`, `UPDATE_USER`, `UPDATE_TIMESTAMP`, `RIGHTS_TYPE_CODE`) 
VALUES ((SELECT A.ID FROM (SELECT MAX(RIGHT_ID) + 1 AS ID FROM RIGHTS ) AS A),'MAINTAIN_PRIVATE_NOTES', 'To add and view private notes', 'quickstart', now(), '2');

INSERT INTO`rights` (`RIGHT_ID`, `RIGHT_NAME`, `DESCRIPTION`, `UPDATE_USER`, `UPDATE_TIMESTAMP`, `RIGHTS_TYPE_CODE`) 
VALUES ((SELECT A.ID FROM (SELECT MAX(RIGHT_ID) + 1 AS ID FROM RIGHTS ) AS A),'VIEW_PRIVATE_NOTES', 'To view private notes', 'quickstart', now(), '2');

ALTER TABLE `notes` 
ADD COLUMN `TITLE` VARCHAR(255) NULL AFTER `PERSON_ID`;

ALTER TABLE `notes` 
ADD COLUMN `IS_PRIVATE` VARCHAR(1) NULL AFTER `CONTENT`;

        ...
        SET LS_DYN_SQL =CONCAT('SELECT DISTINCT *  FROM(SELECT DISTINCT
                                        ...
                                        ELSE
                                            CASE WHEN T1.FCOI_TYPE_CODE = 2 AND T61.PROJECT_SNAPSHOT IS NOT NULL THEN
                                                CONVERT(T61.PROJECT_SNAPSHOT->>''$.PROJECT_TITLE'' USING latin1) COLLATE latin1_swedish_ci
                                            ELSE NULL END
                                        ...
                                        ELSE
                                            CASE WHEN T1.FCOI_TYPE_CODE = 2 AND T61.PROJECT_SNAPSHOT IS NOT NULL THEN
                                                CONVERT(T61.PROJECT_SNAPSHOT->>''$.PROJECT_NUMBER'' USING latin1) COLLATE latin1_swedish_ci
                                            ELSE NULL END

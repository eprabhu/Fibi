...
INSERT INTO `valid_person_entity_rel_type` (`VALID_PERSON_ENTITY_REL_TYPE_CODE`,`DISCLOSURE_TYPE_CODE`,`RELATIONSHIP_TYPE_CODE`,`DESCRIPTION`,`QUESTIONNAIRE_NUMBER`,`IS_ACTIVE`,`UPDATE_TIMESTAMP`,`UPDATE_USER`) VALUES (1,'1','1','test',NULL,'Y',now(),'quickstart');
INSERT INTO `valid_person_entity_rel_type` (`VALID_PERSON_ENTITY_REL_TYPE_CODE`,`DISCLOSURE_TYPE_CODE`,`RELATIONSHIP_TYPE_CODE`,`DESCRIPTION`,`QUESTIONNAIRE_NUMBER`,`IS_ACTIVE`,`UPDATE_TIMESTAMP`,`UPDATE_USER`) VALUES (2,'1','2','test',NULL,'Y',now(),'quickstart');
INSERT INTO `valid_person_entity_rel_type` (`VALID_PERSON_ENTITY_REL_TYPE_CODE`,`DISCLOSURE_TYPE_CODE`,`RELATIONSHIP_TYPE_CODE`,`DESCRIPTION`,`QUESTIONNAIRE_NUMBER`,`IS_ACTIVE`,`UPDATE_TIMESTAMP`,`UPDATE_USER`) VALUES (3,'1','3','test',NULL,'Y',now(),'quickstart');

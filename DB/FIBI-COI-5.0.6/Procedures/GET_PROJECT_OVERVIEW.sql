...
SET LS_OFFSET = (AV_LIMIT * AV_PAGED);
    ...
    SET LS_JOIN_CONDITION = CONCAT(LS_JOIN_CONDITION, ' INNER JOIN PERSON T2 ON T1.KEY_PERSON_ID = T2.PERSON_ID
														...
														LEFT JOIN COI_DISCLOSURE T6 ON T6.PERSON_ID = T1.KEY_PERSON_ID
														LEFT JOIN COI_DISCL_PROJECTS T22 ON T22.MODULE_ITEM_KEY = T1.EXTERNAL_SYSTEM_REF_ID
														    AND T22.MODULE_CODE = T1.COI_PROJECT_TYPE_CODE AND T6.DISCLOSURE_ID = T22.DISCLOSURE_ID

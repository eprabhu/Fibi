...
ALTER TABLE COI_INT_STAGE_DEV_PROPOSAL_PERSON ADD COLUMN CERTIFICATION_FLAG VARCHAR(12) DEFAULT NULL AFTER STATUS;
ALTER TABLE COI_INT_STAGE_DEV_PROPOSAL_PERSON ADD COLUMN DISCLOSURE_REQUIRED_FLAG VARCHAR(12) DEFAULT NULL AFTER CERTIFICATION_FLAG;

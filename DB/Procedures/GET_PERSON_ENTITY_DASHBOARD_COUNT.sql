...
END IF;
    ...
    SET LS_DYN_SQL = CONCAT('SELECT COUNT(DISTINCT *)  FROM (SELECT T1.PERSON_ENTITY_ID, T1.PERSON_ID, T2.FULL_NAME, T1.ENTITY_ID, T1.ENTITY_NUMBER, T1.IS_RELATIONSHIP_ACTIVE, 

...
SET SEARCH_CONDITION = '';
    ...
    IF AV_DISCLOSURE_ID IS NOT NULL AND (AV_REVIEW_STATUS_CODE IS NULL OR AV_REVIEW_STATUS_CODE NOT IN ('1', '6', '5')) THEN
        ...
        SET LS_DYN_SQL = CONCAT('SELECT DISTINCT t1.PERSON_ENTITY_ID, t1.PERSON_ID, t1.ENTITY_ID, t1.ENTITY_NUMBER, t1.INVOLVEMENT_START_DATE, t1.INVOLVEMENT_END_DATE, 
            ...
            t4.COUNTRY_NAME, t3.DESCRIPTION AS ENTITY_TYPE, t1.VERSION_STATUS, t1.IS_RELATIONSHIP_ACTIVE FROM COI_DISCL_ENT_PROJ_DETAILS dd 
    ...
    ELSE 
        ...
        ELSE
            ...
            SET SELECTED_FIELD_LIST= CONCAT( ' DISTINCT t1.PERSON_ENTITY_ID, t1.PERSON_ID, t1.ENTITY_ID, t1.ENTITY_NUMBER, t1.INVOLVEMENT_START_DATE, t1.INVOLVEMENT_END_DATE, 
                                    t2.ENTITY_NAME, t2.ENTITY_TYPE_CODE, t2.IS_ACTIVE AS ENTITY_ACTIVE, t2.VERSION_STATUS AS ENTITY_VERSION_STATUS, 
                                    t4.COUNTRY_NAME, t3.DESCRIPTION AS ENTITY_TYPE, t1.VERSION_STATUS, t1.IS_RELATIONSHIP_ACTIVE ');
        END IF;

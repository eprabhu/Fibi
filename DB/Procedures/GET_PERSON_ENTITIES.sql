    ...
    ELSE 
        ...
        ELSE
            ...
            SET SELECTED_FIELD_LIST= CONCAT( ' DISTINCT t1.PERSON_ENTITY_ID, t1.PERSON_ENTITY_NUMBER, t1.PERSON_ID, t1.ENTITY_ID, t1.ENTITY_NUMBER, t1.INVOLVEMENT_START_DATE, t1.INVOLVEMENT_END_DATE, 
                                    ...
                                    CASE WHEN ( t5.PERSON_ENTITY_ID IS NOT NULL ) THEN false ELSE  true END AS CAN_DELETE, t1.VERSION_NUMBER ');
            set JOIN_CONDITION = CONCAT(' LEFT JOIN (SELECT t1.PERSON_ENTITY_ID FROM PERSON_ENTITY t1 INNER JOIN coi_discl_ent_proj_details t2 ON t2.PERSON_ENTITY_ID = t1.PERSON_ENTITY_ID
                                 INNER JOIN coi_disclosure t3 ON t3.DISCLOSURE_ID = t2.DISCLOSURE_ID WHERE t3.REVIEW_STATUS_CODE NOT IN (1, 5, 6) and t1.PERSON_ID = ', AV_PERSON_ID, '
                                 ...
                                 INNER JOIN OPA_DISCLOSURE t3 ON  t3.OPA_DISCLOSURE_ID = t2.OPA_DISCLOSURE_ID WHERE t3.REVIEW_STATUS_CODE NOT IN (1, 5, 6) AND t1.PERSON_ID = ', AV_PERSON_ID, '
                                 ...
                                 WHERE t2.REVIEW_STATUS_CODE NOT IN(1, 5, 6) AND t1.PERSON_ID = ', AV_PERSON_ID, ') t5 ON t5.PERSON_ENTITY_ID = t1.PERSON_ENTITY_ID ');
        END IF;

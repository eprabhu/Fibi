...
ELSEIF AV_TAB_TYPE = 'TRAVEL_DISCLOSURES' THEN
				SET TAB_QUERY = CONCAT(TAB_QUERY,'WHERE T21.VERSION_STATUS IN (''DRAFT'',''ACTIVE'')
								AND T21.PERSON_ID = ''', AV_PERSON_ID ,''' ');
...
ELSE
	SET SELECTED_FIELD_LIST= CONCAT(SELECTED_FIELD_LIST,'T1.DISCLOSURE_ID, T1.DISCLOSURE_NUMBER, T1.VERSION_NUMBER, T1.PERSON_ID, T7.FULL_NAME AS DISCLOSURE_PERSON_FULL_NAME,
										...
										T13.ENTITY_NAMES, T13.ENTITY_COUNTRIES, T14.PROPOSAL_IDS, T14.PROPOSAL_TITLES, T15.AWARD_IDS,

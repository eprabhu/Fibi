...
ELSEIF AV_TAB_TYPE = 'TRAVEL_DISCLOSURES' THEN
				SET TAB_QUERY = CONCAT(TAB_QUERY,'WHERE T21.REVIEW_STATUS_CODE IN (2, 3, 6, 7) AND T21.VERSION_STATUS = ''PENDING'' ');
...
IF AV_TAB_TYPE = 'TRAVEL_DISCLOSURES' THEN
	SET SELECTED_FIELD_LIST= CONCAT(SELECTED_FIELD_LIST,'T21.TRAVEL_DISCLOSURE_ID, 
							...
							T30.DOCUMENT_STATUS_CODE,
							T30.DESCRIPTION AS DOCUMENT_STATUS_DESCRIPTION,
							T21.TRAVEL_END_DATE ');
						
	SET JOIN_CONDITION = CONCAT(' LEFT JOIN ENTITY T22 ON T22.ENTITY_ID=T21.ENTITY_ID
								  ...
								  LEFT JOIN COI_TRAVEL_DOCUMENT_STATUS T30 ON T30.DOCUMENT_STATUS_CODE = T21.DOCUMENT_STATUS_CODE
     ...
     SET LS_DYN_SQL = CONCAT('SELECT DISTINCT *  FROM(SELECT DISTINCT ',SELECTED_FIELD_LIST,'
							FROM COI_TRAVEL_DISCLOSURE T21 ', JOIN_CONDITION, TAB_QUERY,

...
ELSEIF AV_TAB_TYPE = 'PENDING_DISCLOSURES' THEN
                ...
                SET TAB_QUERY = CONCAT(TAB_QUERY,' ',LS_ADMIN_GROUP_CONDITION ,' OR T23.ASSIGNEE_PERSON_ID = ''',AV_PERSON_ID,'''  AND T23.REVIEW_STATUS_TYPE_CODE IN (3,4))');
...
ELSEIF AV_TAB_TYPE = 'ALL_REVIEWS' THEN
				...
				SET TAB_QUERY = CONCAT(' AND T1.REVIEW_STATUS_CODE IN (3,4)');

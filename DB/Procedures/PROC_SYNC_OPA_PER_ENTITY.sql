...
BEGIN
    ...
    INSERT INTO OPA_DISCL_PERSON_ENTITY (OPA_DISCLOSURE_ID, PERSON_ENTITY_ID, ENTITY_ID, ENTITY_NUMBER,UPDATE_TIMESTAMP, UPDATE_USER)
	 SELECT
	...
	(
		...
		AND t0.PERSON_ENTITY_ID NOT IN (
											SELECT PERSON_ENTITY_ID
											FROM OPA_DISCL_PERSON_ENTITY													
											WHERE OPA_DISCLOSURE_ID = AV_OPA_DISCLOSURE_ID
									   )
	) T;

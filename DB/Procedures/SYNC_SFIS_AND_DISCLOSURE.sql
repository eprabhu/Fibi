        ...
        */
        ...
        ELSEIF AV_TYPE = 'SD' AND AV_DISCLOSURE_ID IS NOT NULL THEN
            BEGIN
                ...
                SELECT REVIEW_STATUS_CODE INTO LI_DISCLOSURE_STATUS FROM COI_DISCLOSURE WHERE DISCLOSURE_ID = AV_DISCLOSURE_ID;
                ...
                DELETE T2, T FROM COI_DISCL_ENT_PROJ_DETAILS T
                    ...
                    AND T1.DISCLOSURE_ID = AV_DISCLOSURE_ID) AS T3 ON T3.PERSON_ENTITY_NUMBER = T.PERSON_ENTITY_NUMBER

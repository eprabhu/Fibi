...
BEGIN
    ...
    IF AV_MODULE_CODE = 1 THEN
		...
		IF AV_DISCLOSURE_ID is not null THEN
            ...
            T2.ACCOUNT_NUMBER, T2.SPONSOR_AWARD_NUMBER, T4.CONFLICT_DESCRIPTION, T4.PROJECT_CONFLICT_STATUS_CODE 
            ...
            LEFT JOIN (SELECT DISCLOSURE_DETAILS_ID ,T6.DESCRIPTION AS CONFLICT_DESCRIPTION, MODULE_ITEM_KEY,
            MODULE_CODE, MAX(T5.PROJECT_CONFLICT_STATUS_CODE) AS PROJECT_CONFLICT_STATUS_CODE
            FROM COI_DISCL_ENT_PROJ_DETAILS T5 
            INNER JOIN COI_PROJ_CONFLICT_STATUS_TYPE T6 ON T6.PROJECT_CONFLICT_STATUS_CODE = T5.PROJECT_CONFLICT_STATUS_CODE 
		...
		ELSE
			...
			T1.ACCOUNT_NUMBER, T1.SPONSOR_AWARD_NUMBER
	...
	ELSE IF AV_MODULE_CODE = 3 THEN
		...
		IF AV_DISCLOSURE_ID is not null THEN
            ...
            T4.CONFLICT_DESCRIPTION, T4.PROJECT_CONFLICT_STATUS_CODE 
            FROM COI_DISCL_ENT_PROJ_DETAILS T1 

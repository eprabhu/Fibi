...
BEGIN
    ...
    IF AV_MODULE_CODE = 1 THEN
		...
		IF AV_DISCLOSURE_ID is not null THEN
            ...
            T5.FULL_NAME AS PI, T6.DESCRIPTION AS STATUS FROM COI_DISCLOSURE T1 INNER JOIN AWARD T2 ON  
	...
	ELSE IF AV_MODULE_CODE = 3 THEN
		...
		IF AV_DISCLOSURE_ID is not null THEN
            ...
            T4.SPONSOR_NAME AS SPONSOR_NAME, T5.SPONSOR_NAME AS PRIME_SPONSOR_NAME, T6.FULL_NAME AS PI FROM COI_DISCL_ENT_PROJ_DETAILS T1 INNER JOIN EPS_PROPOSAL T2 
            ...
            INNER JOIN EPS_PROPOSAL_PERSONS T6 ON (T6.PROPOSAL_ID=T2.PROPOSAL_ID AND T6.PROP_PERSON_ROLE_ID = 3 AND T6.PI_FLAG = 'Y')

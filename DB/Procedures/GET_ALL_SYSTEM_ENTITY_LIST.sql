...
IF AV_TAB_TYPE = 'ALL_ENTITIES' THEN
                ...
                SET TAB_QUERY = CONCAT(' AND T1.ENTITY_STATUS_CODE IN (1,2,3)' );

        ELSEIF AV_TAB_TYPE = 'UNVERIFIED' THEN

		SET TAB_QUERY = CONCAT(' AND T1.ENTITY_STATUS_CODE = 3' );
...
FROM (
    ...
    , JOIN_CONDITION, ' WHERE T1.VERSION_STATUS != ''ARCHIVED'' ', TAB_QUERY, ') T ', LS_FILTER_CONDITION, ' ', AV_SORT_TYPE, ' ', LS_OFFSET_CONDITION, ';');

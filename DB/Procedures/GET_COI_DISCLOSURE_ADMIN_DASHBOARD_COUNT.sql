...
END IF;
        ...
        SET LS_DYN_SQL = CONCAT('SELECT DISTINCT COUNT(*)  FROM(SELECT DISTINCT
										...
										LEFT JOIN (SELECT T1.DISCLOSURE_ID,GROUP_CONCAT(DISTINCT(T4.COI_ENTITY_NAME) SEPARATOR ", ") AS ENTITY_NAMES, 
													...
													INNER JOIN COI_ENTITY T4 ON T4.COI_ENTITY_ID = T3.COI_ENTITY_ID 

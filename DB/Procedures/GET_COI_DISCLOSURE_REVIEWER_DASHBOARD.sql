...
ELSEIF AV_TAB_TYPE = 'PENDING_DISCLOSURES' THEN
                ...
                INNER JOIN COI_REVIEW_STATUS_TYPE T24 ON T24.REVIEW_STATUS_CODE = T23.REVIEW_STATUS_CODE
...
IF AV_TYPE ='A' THEN
				...
				IF AV_DISCLOSURE_STATUS_CODE IS NOT NULL  AND AV_DISCLOSURE_STATUS_CODE <> '' THEN
					...
					SET LS_FILTER_CONDITION = CONCAT(LS_FILTER_CONDITION,' T.VERSION_STATUS IN (',AV_DISCLOSURE_STATUS_CODE,') AND ');

...
IF AV_TAB_TYPE = 'NEW_SUBMISSIONS' THEN
		...
		SET TAB_QUERY = CONCAT(' AND T17.REVIEW_STATUS_TYPE_CODE = 1 ');
ELSEIF AV_TAB_TYPE = 'MY_REVIEWS' THEN

        SET TAB_QUERY = CONCAT(' AND T17.REVIEW_STATUS_TYPE_CODE = 2 ');
ELSEIF AV_TAB_TYPE = 'REVIEW_HISTORY' THEN

        SET TAB_QUERY = CONCAT(' AND T17.REVIEW_STATUS_TYPE_CODE = 3 ');
END IF; 

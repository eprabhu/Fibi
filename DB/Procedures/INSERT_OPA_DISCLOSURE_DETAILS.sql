...
DECLARE LS_OPA_CYCLE_NUMBER int(11);
...
DECLARE LS_OPA_DISCLOSURE_ID int(11);
...
SELECT MAX(OPA_CYCLE_NUMBER) INTO LS_OPA_CYCLE_NUMBER FROM OPA_CYCLES;

INSERT INTO OPA_DISCLOSURE(OPA_DISCLOSURE_NUMBER, OPA_CYCLE_NUMBER, PERSON_ID, PERSON_NAME, HOME_UNIT, IS_FACULTY, CREATE_USER, CREATE_TIMESTAMP, UPDATE_USER, UPDATE_TIMESTAMP) 
VALUES 
(CONCAT('OPA', LS_OPA_DISCLOSURE_NUMBER), LS_OPA_CYCLE_NUMBER, AV_PERSON_ID, LS_PERSON_NAME, AV_HOME_UNIT, LS_IS_FACULTY, AV_LOGGEDIN_USER, now(), AV_LOGGEDIN_USER, now());

SELECT LAST_INSERT_ID() INTO LS_OPA_DISCLOSURE_ID;
SELECT LS_OPA_DISCLOSURE_ID;

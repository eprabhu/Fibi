...
VALUES 
(CONCAT(LS_PREFIX, LS_OPA_DISCLOSURE_NUMBER), LI_OPA_CYCLE_NUMBER, AV_PERSON_ID, LS_PERSON_NAME, AV_HOME_UNIT, LS_IS_FACULTY, AV_LOGGEDIN_USER, now(), AV_LOGGEDIN_USER, now());

...
UNION
    ...
    FROM PERSON_ROLE_RT T1
    WHERE T1.PERSON_ID = AV_PERSON_ID
    AND T1.UNIT_NUMBER IN (
        SELECT G1.HOME_UNIT_NUMBER
        FROM AWARD AWD1
...
UNION
    ...
    SELECT DISTINCT T1.RIGHT_NAME FROM PERSON_ROLE_RT T1
    WHERE T1.PERSON_ID = (SELECT DISTINCT PERSON_ID
...
ELSEIF AV_MODULE_CODE = 8 THEN
    ...
    FROM PERSON_ROLE_RT T1
    WHERE T1.PERSON_ID = AV_PERSON_ID
    AND T1.RIGHT_NAME IN ('MANAGE_FCOI_DISCLOSURE', 'VIEW_FCOI_DISCLOSURE', 'MANAGE_PROJECT_DISCLOSURE', 'VIEW_PROJECT_DISCLOSURE',
        'VIEW_TRAVEL_DISCLOSURE', 'MANAGE_ENTITY', 'VIEW_ENTITY');

ELSEIF AV_MODULE_CODE = 23 THEN
	SELECT DISTINCT T1.RIGHT_NAME
    FROM PERSON_ROLE_RT T1
    WHERE T1.PERSON_ID = AV_PERSON_ID
    AND T1.RIGHT_NAME IN ('MANAGE_OPA_DISCLOSURE', 'VIEW_OPA_DISCLOSURE', 'VIEW_OPA_DISCLOSURE_PRIVATE_COMMENTS', 'VIEW_OPA_DISCLOSURE_PRIVATE_ATTACHMENTS');

...
IF AV_TYPE IS NOT NULL AND AV_TYPE <> '' AND  AV_TYPE = 'FINANCIAL_DISCLOSURES' THEN 
    ...
    SET TAB_QUERY = CONCAT(TAB_QUERY,' WHERE T13.ENTITY_ID =',AV_ENTITY_ID, ' AND T1.VERSION_STATUS_CODE = ''1'' AND T13.IS_RELATIONSHIP_ACTIVE = ''Y'' ');
...
END IF;
	...
	SET LS_DYN_SQL = CONCAT(' SELECT DISTINCT *  FROM(SELECT DISTINCT
	                            ...
	                            T21.TRAVEL_NUMBER,
	                            T21.ENTITY_ID,
								T21.VERSION_STATUS_CODE AS TRAVEL_DISCLOSURE_STATUS,
	                            T5.UNIT_NUMBER AS UNIT,
								T5.UNIT_NAME,
								T5.ORGANIZATION_ID,
								T5.PARENT_UNIT_NUMBER,

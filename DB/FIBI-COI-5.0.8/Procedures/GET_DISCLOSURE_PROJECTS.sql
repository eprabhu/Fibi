...
BEGIN
        ...
        SELECT DISTINCT
			...
			T11.DESCRIPTION AS PROJECT_CONFLICT_STATUS,
			T10.PROJECT_CONFLICT_STATUS_CODE 
            ...
            LEFT JOIN COI_DISCL_PROJECT_ENTITY_REL T10 ON T10.COI_DISCL_PROJECTS_ID = T1.COI_DISCL_PROJECTS_ID   
			LEFT JOIN COI_PROJ_CONFLICT_STATUS_TYPE T11 ON T11.PROJECT_CONFLICT_STATUS_CODE = T10.PROJECT_CONFLICT_STATUS_CODE

...
ELSEIF AV_MODULE_CODE = 8 THEN
	...
	SELECT HOME_UNIT INTO LS_LEAD_UNIT FROM COI_DISCLOSURE WHERE DISCLOSURE_ID = AV_MODULE_ITEM_KEY;
	...
	WHERE T3.PERSON_ID = AV_LOGGED_IN_PERSON_ID)) OR ADMIN_PERSON_ID = AV_LOGGED_IN_PERSON_ID);
        ...
        WHERE T1.DISCLOSURE_ID = AV_MODULE_ITEM_KEY AND T1.ASSIGNEE_PERSON_ID = AV_LOGGED_IN_PERSON_ID AND T2.REVIEW_STATUS_CODE <> 5;
        IF LI_COUNT > 0 THEN
            RETURN LI_AUTHORIZED;
        END IF;

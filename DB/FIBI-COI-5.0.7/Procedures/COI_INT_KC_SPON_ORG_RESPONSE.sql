...
SET LS_ACTION_MSGE = CONCAT('Sponsor feed status of ',LS_ENTITY_NAME,' <b>updated</b> from <b>',LS_PREV_STATUS,'</b> to <b>',LS_CURRENT_STATUS,'</b>');

INSERT INTO ENTITY_ACTION_LOG 
(ENTITY_ID, ENTITY_NUMBER, ACTION_TYPE_CODE, DESCRIPTION, COMMENT, UPDATE_TIMESTAMP, UPDATE_USER)
VALUES 
(AV_ENTITY_ID, AV_ENTITY_ID, 10, LS_ACTION_MSGE, NULL, NOW(), 'willsmith');
...
SET LS_ACTION_MSGE = CONCAT('Organization feed status of ',LS_ENTITY_NAME,' <b>updated</b> from <b>',LS_PREV_STATUS,'</b> to <b>',LS_CURRENT_STATUS,'</b>');

INSERT INTO ENTITY_ACTION_LOG 
(ENTITY_ID, ENTITY_NUMBER, ACTION_TYPE_CODE, DESCRIPTION, COMMENT, UPDATE_TIMESTAMP, UPDATE_USER)
VALUES 
(AV_ENTITY_ID, AV_ENTITY_ID, 11, LS_ACTION_MSGE,NULL, NOW(), 'willsmith');

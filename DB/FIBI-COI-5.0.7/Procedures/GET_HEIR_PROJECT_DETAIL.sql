...
BEGIN
	...
	IF LS_COUNT > 0 THEN 
		IF AV_MODULE_CODE = 1 THEN 
            ...
            WHERE T6.PROJECT_NUMBER = AV_PROJECT_NUMBER;
		ELSE IF AV_MODULE_CODE = 2 THEN 
			...
			LEFT JOIN EPS_PROP_PERSON_ROLE T15 ON T15.PROP_PERSON_ROLE_ID = T7.KEY_PERSON_ROLE_CODE
            WHERE T6.PROJECT_NUMBER = AV_PROJECT_NUMBER ORDER BY SORT_ID;
		ELSE IF AV_MODULE_CODE = 3 THEN 
			...
			LEFT JOIN EPS_PROP_PERSON_ROLE T15 ON T15.PROP_PERSON_ROLE_ID = T7.KEY_PERSON_ROLE_CODE
            WHERE T6.PROPOSAL_NUMBER = AV_PROJECT_NUMBER ORDER BY SORT_ID;
		END IF;
		END IF;
		END IF;
	ELSE
		IF AV_MODULE_CODE = 1 THEN 
            ...
            WHERE T12.AWARD_SEQUENCE_STATUS <> 'ARCHIVE' AND T12.AWARD_NUMBER = AV_PROJECT_NUMBER;
		ELSE IF AV_MODULE_CODE = 2 THEN 
            ...
            WHERE T12.PROPOSAL_SEQUENCE_STATUS <> 'ARCHIVE' AND T12.PROPOSAL_NUMBER = AV_PROJECT_NUMBER;
		ELSE IF AV_MODULE_CODE = 3 THEN 

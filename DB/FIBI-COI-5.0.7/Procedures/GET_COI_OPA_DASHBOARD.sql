...
END IF;
    ...
    ELSEIF AV_TAB_TYPE = 'ALL_REVIEWS' THEN
      ...
      SET LS_FILTER_CONDITION = CONCAT(' T1.REVIEW_STATUS_CODE IN (8,4)AND ((''', AV_PERSON_ID ,''' IN (SELECT T8.ASSIGNEE_PERSON_ID WHERE T8.REVIEW_STATUS_TYPE_CODE = 3))) ');
    ...
    insert into abc(bb)value(LS_DYN_SQL);

...
END IF;
				...
				SET JOIN_CONDITION =  CONCAT(JOIN_CONDITION,' LEFT JOIN COI_DISCL_PROJECTS T9 ON T9.DISCLOSURE_ID = T1.DISCLOSURE_ID
										...
										LEFT  JOIN (SELECT AWARD_NUMBER  AS AWARD_IDS, EXTERNAL_SYSTEM_REF_ID,
												   TITLE AS AWARD_TITLES FROM COI_PROJECT_AWARD_V )T15  ON T15.EXTERNAL_SYSTEM_REF_ID = T9.MODULE_ITEM_KEY
										LEFT  JOIN (SELECT PROPOSAL_NUMBER  AS IP_NUMBER, EXTERNAL_SYSTEM_REF_ID,
												   TITLE AS IP_TITLE FROM COI_PROJECT_INSTITUTE_PROPOSAL_V )T16  ON T16.EXTERNAL_SYSTEM_REF_ID = T9.MODULE_ITEM_KEY ');

...
END IF;
	...
	SET JOIN_CONDITION = CONCAT(
								...
								LEFT JOIN (
										SELECT EXTERNAL_SYSTEM_REF_ID AS PROPOSAL_ID, TITLE AS PROPOSAL_TITLE, EXTERNAL_SYSTEM_REF_ID, COI_PROJECT_TYPE_CODE
										FROM COI_PROJECT_PROPOSAL_V
									) T14 ON T14.EXTERNAL_SYSTEM_REF_ID = T50.MODULE_ITEM_KEY AND T14.COI_PROJECT_TYPE_CODE = T1.COI_PROJECT_TYPE_CODE
								LEFT JOIN (
										SELECT AWARD_NUMBER , EXTERNAL_SYSTEM_REF_ID, TITLE AS AWARD_TITLE, COI_PROJECT_TYPE_CODE
										FROM COI_PROJECT_AWARD_V
									) T15 ON T15.EXTERNAL_SYSTEM_REF_ID = T50.MODULE_ITEM_KEY AND T15.COI_PROJECT_TYPE_CODE = T1.COI_PROJECT_TYPE_CODE
								LEFT JOIN (
									...
									) T21 ON T21.EXTERNAL_SYSTEM_REF_ID = T50.MODULE_ITEM_KEY AND T21.COI_PROJECT_TYPE_CODE = T1.COI_PROJECT_TYPE_CODE
								LEFT JOIN (

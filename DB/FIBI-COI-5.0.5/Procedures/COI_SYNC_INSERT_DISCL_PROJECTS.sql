...
BEGIN
    ...
    FROM (
		...
		LEFT JOIN SPONSOR_DISCLOSURE_REQUIREMENTS T3 ON T3.PRIME_SPONSOR_CODE = T1.SPONSOR_CODE
		...
		AND EXTERNAL_SYSTEM_REF_ID NOT IN (
			...
			OR (T1.PCK = '' AND T1.KEY_PERSON_ROLE_CODE IN(1,3))
		)
		AND T1.AWARD_STATUS IN (1,6,3)

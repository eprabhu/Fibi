...
CREATE TABLE ENTITY_RISK_CATEGORY (
  RISK_CATEGORY_CODE varchar(3) NOT NULL,OPA_DISPOSITION_STATUS_TYPE
...
CREATE TABLE FORM_BUILDER_SECTION (
  ...
  SECTION_ORDER_NUMBER int NOT NULL,
  MODULE_CODE varchar(3) NOT NULL,
  SUB_MODULE_CODE varchar(3) NOT NULL,
  BUSINESS_RULE_ID int DEFAULT NULL,
  DESCRIPTION varchar(300) NOT NULL,
...
CREATE TABLE FORM_BUILDER_SECTION_COMPONENT (
  ...
  FORM_BUILDER_SECTION_ID int NOT NULL,
  COMPONENT_TYPE_CODE varchar(3) NOT NULL,
  COMPONENT_ORDER_NUMBER int NOT NULL,

...
public interface ConsultingDisclosureDao {
	...
	/**
	 * This method is used to save person entity details in consulting disclosure
	 * @param disclosureId
	 * @param personEntityId
	 * @param entityNumber
	 * @return update timestamp
	 */
	Timestamp savePersonEntityDetails(Integer personEntityId, Integer disclosureId, Integer entityNumber);

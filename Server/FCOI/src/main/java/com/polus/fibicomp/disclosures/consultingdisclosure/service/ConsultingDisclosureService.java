...
public interface ConsultingDisclosureService {
	...
	/**
	 * This method is used to save person entity details of consulting disclosure
	 * @param consultDisclCommonDto
	 * @return consulting disclosure
	 */
	ResponseEntity<Object> savePersonEntityDetails(ConsultDisclCommonDto consultDisclCommonDto);

 ...
 * 
 * <p>Java class for Proposed_Allowance_Unit_Plan_Assignment_Container_DataType complex type.
 * 
...
@XmlType(name = "Proposed_Allowance_Unit_Plan_Assignment_Container_DataType", propOrder = {
    "unitAllowancePlanSubData"
})
public class ProposedAllowanceUnitPlanAssignmentContainerDataType {
     ...
     * This is why there is not a <CODE>set</CODE> method for the unitAllowancePlanSubData property.
     * 
     * <p>
     ...
     * {@link ProposedAllowanceUnitPlanAssignmentDataType }
     * 
     * 
     */
    public List<ProposedAllowanceUnitPlanAssignmentDataType> getUnitAllowancePlanSubData() {
        if (unitAllowancePlanSubData == null) {
            unitAllowancePlanSubData = new ArrayList<ProposedAllowanceUnitPlanAssignmentDataType>();
        }

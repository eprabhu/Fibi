...
public class ConsultingDisclController {
	...
	@PatchMapping("/savePersonEntityDetails")
	public ResponseEntity<Object> savePersonEntityDetails(@RequestBody ConsultDisclCommonDto dto) {
		logger.info("Request for savePersonEntityDetails");
		return consultDisclService.savePersonEntityDetails(dto);
	}

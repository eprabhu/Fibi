 ...
 * 
 * <p>Java class for Proposed_Allowance_Plan_Assignment_Container_DataType complex type.
 * 
...
@XmlType(name = "Proposed_Allowance_Plan_Assignment_Container_DataType", propOrder = {
    "allowancePlanSubData"
})
public class ProposedAllowancePlanAssignmentContainerDataType {

    @XmlElement(name = "Allowance_Plan_Sub_Data")
     ...
     * This is why there is not a <CODE>set</CODE> method for the allowancePlanSubData property.
     * 
     * <p>
     ...
     * {@link ProposedAllowancePlanAssignmentDataType }
     * 
     * 
     */
    public List<ProposedAllowancePlanAssignmentDataType> getAllowancePlanSubData() {
        if (allowancePlanSubData == null) {
            allowancePlanSubData = new ArrayList<ProposedAllowancePlanAssignmentDataType>();
        }
        return this.allowancePlanSubData;
    }

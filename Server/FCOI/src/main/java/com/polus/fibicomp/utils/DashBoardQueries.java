...
//---------------------------------------------------------------------------Units wit rigths of person--------------------------------------------------
		...
		String UNIT_WITH_RIGHT_OF_PERSON = "SELECT DISTINCT UNIT_NUMBER, UNIT_NAME, PARENT_UNIT_NUMBER from UNIT WHERE UNIT_NUMBER IN\r\n" + 
				"(select UNIT_NUMBER  FROM PERSON_ROLE_RT T2 WHERE T2.PERSON_ID =:personId AND T2.RIGHT_NAME IN ('APPLICATION_ADMINISTRATOR',\r\n" + 
				"'MODIFY_PROPOSAL','VIEW_PROPOSAL', 'VIEW_AWARD', 'MODIFY_AWARD')\r\n" + 
				"UNION \r\n" + 
				"SELECT UNIT_NUMBER FROM UNIT_ADMINISTRATOR WHERE PERSON_ID =:personId AND UNIT_ADMINISTRATOR_TYPE_CODE = 3) ";

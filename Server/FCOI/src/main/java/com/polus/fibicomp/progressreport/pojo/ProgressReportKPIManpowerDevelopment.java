...
@Entity
@Table(name = "PROGRESS_REPORT_KPI_MANPOWER_DEVELOPMENT")
@EntityListeners(AuditingEntityListener.class)
public class ProgressReportKPIManpowerDevelopment implements Serializable{

	private static final long serialVersionUID = 1L;

	@Id
	@Column(name = "KPI_MANPOWER_DEVELOPMENT_ID")
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private Integer kpiManpowerDevelopmentId;
	...
	@ManyToOne
	@JoinColumn(foreignKey = @ForeignKey(name = "KPI_MANPOWER_DEVELOPMENT_FK1"), name = "CURRENT_STATUS_CODE", referencedColumnName = "CURRENT_STATUS_CODE", insertable = false, updatable = false)
	private KPIManpowerDevelopmentCurrentStatus kpiManpowerDevelopmentCurrentStatus;

	public Integer getKpiManpowerDevelopmentId() {
		return kpiManpowerDevelopmentId;
	}

	public void setKpiManpowerDevelopmentId(Integer kpiManpowerDevelopmentId) {
		this.kpiManpowerDevelopmentId = kpiManpowerDevelopmentId;
	}

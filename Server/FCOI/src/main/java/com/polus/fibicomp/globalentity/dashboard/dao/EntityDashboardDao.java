		...
		while (retryCount < DEADLOCK_RETRY_COUNT && !success) {
			try {
				...
				while (resultSet != null && resultSet.next()) {
					...
					dashboardResponse.setPrimaryAddressLine1(resultSet.getString("PRIMARY_ADDRESS_LINE_1"));
					dashboardResponse.setPrimaryAddressLine2(resultSet.getString("PRIMARY_ADDRESS_LINE_2"));

...
public class ConsultingDisclosure {
	...
	@ManyToOne(optional = true)
	@JoinColumn(foreignKey = @ForeignKey(name = "CONSULTING_DISCL_ FK5"), name = "PERSON_ENTITY_ID", referencedColumnName = "PERSON_ENTITY_ID", insertable = false, updatable = false)

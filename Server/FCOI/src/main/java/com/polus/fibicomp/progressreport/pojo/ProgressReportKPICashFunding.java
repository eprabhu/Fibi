...
@Entity
@Table(name = "PROGRESS_REPORT_KPI_CASH_FUNDING")
@EntityListeners(AuditingEntityListener.class)
public class ProgressReportKPICashFunding implements Serializable {
	
	private static final long serialVersionUID = 1L;

	@Id
	@Column(name = "KPI_CASH_FUNDING_ID")
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private Integer kpiCashFundingId;
	...
	@ManyToOne
	@JoinColumn(foreignKey = @ForeignKey(name = "KPI_CASH_FUNDING_FK1"), name = "COUNTRY_CODE", referencedColumnName = "COUNTRY_CODE", insertable = false, updatable = false)
	private Country country;

	public Integer getKpiCashFundingId() {
		return kpiCashFundingId;
	}

	public void setKpiCashFundingId(Integer kpiCashFundingId) {
		this.kpiCashFundingId = kpiCashFundingId;
	}

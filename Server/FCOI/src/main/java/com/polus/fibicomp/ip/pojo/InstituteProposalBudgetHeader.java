...
@Entity
@Table(name = "IP_BUDGET_HEADER")
@EntityListeners(AuditingEntityListener.class)
public class InstituteProposalBudgetHeader implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@Column(name = "BUDGET_HEADER_ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_IP_BUD_HEAD_ID_GNTR")
	@SequenceGenerator(name = "SEQ_IP_BUD_HEAD_ID_GNTR", sequenceName = "SEQ_IP_BUD_HEAD_ID_GNTR", allocationSize = 1)
	...
	@JoinColumn(foreignKey = @ForeignKey(name = "IP_BUDGET_HEADER_FK1"), name = "BUDGET_STATUS_CODE", referencedColumnName = "BUDGET_STATUS_CODE", insertable = false, updatable = false)
	...
	@ManyToOne(cascade = { CascadeType.REFRESH })
	@JoinColumn(foreignKey = @ForeignKey(name = "IP_BUDGET_HEADER_FK2"), name = "BUDGET_TYPE_CODE", referencedColumnName = "BUDGET_TYPE_CODE", insertable = false, updatable = false)
	...
	@ManyToOne(cascade = { CascadeType.REFRESH })
	@JoinColumns(foreignKey = @ForeignKey(name = "IP_BUDGET_HEADER_FK3"), value = {
	...
	private List<InstituteProposalBudgetPeriod> budgetPeriods;
	...
	@ManyToOne(cascade = { CascadeType.REFRESH })
	@JoinColumns(foreignKey = @ForeignKey(name = "IP_BUDGET_HEADER_FK5"), value = {
	...
	@ManyToOne(cascade = { CascadeType.REFRESH })
	@JoinColumn(foreignKey = @ForeignKey(name = "IP_BUDGET_HEADER_FK6"), name = "COST_SHARE_TYPE_CODE", referencedColumnName = "COST_SHARE_TYPE_CODE", insertable = false, updatable = false)
	...
	public List<InstituteProposalBudgetPeriod> getBudgetPeriods() {
		return budgetPeriods;
	}

	public void setBudgetPeriods(List<InstituteProposalBudgetPeriod> budgetPeriods) {

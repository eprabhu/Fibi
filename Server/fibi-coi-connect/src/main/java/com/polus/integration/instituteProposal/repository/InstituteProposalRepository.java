...
public interface InstituteProposalRepository extends JpaRepository<COIIntInstituteProposal, Integer> {
	...
	@Modifying
    @Query("UPDATE COIIntInstituteProposal p SET p.linkedAwardProjectNumber = null WHERE p.linkedAwardProjectNumber = :projectNumber")
	Integer unlinkAwardFromAllIPs(String projectNumber);

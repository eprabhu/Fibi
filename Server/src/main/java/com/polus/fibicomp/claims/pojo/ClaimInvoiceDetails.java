...
@Entity
@Table(name = "CLAIM_INVOICE_DETAILS")
@EntityListeners(AuditingEntityListener.class)
public class ClaimInvoiceDetails implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_CLAIM_INVOICE_DETAILS")
	@SequenceGenerator(name = "SEQ_CLAIM_INVOICE_DETAILS", sequenceName = "SEQ_CLAIM_INVOICE_DETAILS", allocationSize = 1)
	...
	@JoinColumn(foreignKey = @ForeignKey(name = "CLAIM_INVOICE_DETAILS_FK1"), name = "INVOICE_ID", referencedColumnName = "INVOICE_ID", insertable = false, updatable = false)
	private ClaimInvoice claimInvoice;
	
	@ManyToOne(optional = true)
	@JoinColumn(foreignKey = @ForeignKey(name = "CLAIM_INVOICE_DETAILS_FK2"), name = "GL_ACCOUNT_CODE", referencedColumnName = "GL_ACCOUNT_CODE", insertable = false, updatable = false)

...
@Entity
@Table(name = "AWARD_BUDGET_RATE_AND_BASE")
public class AwardBudgetRateAndBase implements Serializable {
	...
	@JoinColumn(foreignKey = @ForeignKey(name = "AWARD_BUDGET_RATE_AND_BASE_FK1"), name = "BUDGET_DETAILS_ID", referencedColumnName = "BUDGET_DETAILS_ID")

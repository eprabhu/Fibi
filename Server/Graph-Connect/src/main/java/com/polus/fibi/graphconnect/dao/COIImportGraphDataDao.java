...
public class COIImportGraphDataDao {
	...
	public void importDataFromRDBMS() {	
		...
		//try {
			//CompletableFuture<Void> future1 = CompletableFuture.runAsync(() -> deleteEverything());
			//future1.join();
			deleteEverything();
			refreshDataFromRDBMS();
		//}catch(RuntimeException e) {
		//	throw new CustomGraphException("Runtime Exception in importDataFromRDBMS, error is "+e.getMessage());
		//}
	}
...
//														.thenRunAsync(() ->importPerson(), executorService)

...
public class AwardIntegrationDaoImpl implements AwardIntegrationDao {
	...
	public AwardDTO fetchProjectByProjectNumber(String projectNumber) {
		...
		try
		{
	        ...
	        log.error("Exception in fetchProposalByProposalNumber: {}", e.getMessage(), e);
	        throw new IntegrationCustomException("Error during fetching proposal by number: " + projectNumber, e);
	    }
